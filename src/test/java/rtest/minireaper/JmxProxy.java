...
class JmxProxy {
  ...
  private JmxProxy(JMXConnector jmxConn, MBeanServerConnection mbeanServerConn, StorageServiceMBean ssProxy,
      ActiveRepairServiceMBean rsProxy, CompactionManagerMBean cmProxy) {
  ...
  public static JmxProxy connect(String host, int port) {
    ...
    try {
      ...
      CompactionManagerMBean cmProxy = JMX.newMBeanProxy(mbeanServerConn, cmObjectName, CompactionManagerMBean.class);
  ...
  public int startRepair(
      ...
      Optional<List<Segment>> tokenRanges,
