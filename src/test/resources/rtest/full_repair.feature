...
Feature: Full Repair
  ...
  Scenario Outline: Complete full repair
    ...
    And a "full" repair would find out-of-sync "<tokens>" ranges for keyspace "repair_quality" within 180 minutes
    ...
    And a "full" repair would not find out-of-sync "<tokens>" ranges for keyspace "repair_quality" within 180 minutes
    Examples:
      | parallelism |  tokens |
      |    parallel |     all |
      |  sequential | primary |
